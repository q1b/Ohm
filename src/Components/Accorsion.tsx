  ...
  function classNames(...classes:any) {
	...
	return(
		...
		<div className="w-full flex items-center justify-center">
			...
			{({open})=>(
				<div className={classNames(open ? 'h-48 w-64':'h-24 w-64','bg-white group shadow-md p-4 rounded-lg')} style={{transition:"height 300ms ease-in-out"}}>
			...
			<Transition
			      ...
			      >
				<Disclosure.Panel static className="text-xl text-orange-600 m-0.5 p-0.5 rounded-md ">
					<div className="px-3 py-1 mt-3 bg-gradient-to-tr from-amber-300 rounded-lg to-yellow-200">
