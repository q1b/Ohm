...
export default function Home() {
   ...
   <section className="h-[calc(100vh-96px)] w-full flex items-end justify-center">
				<article className="relative -top-36 sm:-top-10 bg-white dark:bg-green-500 p-4 dark:bg-opacity-20 z-10 bg-opacity-20 w-[300px] lg:w-[675px] backdrop-filter backdrop-blur rounded-lg">			
