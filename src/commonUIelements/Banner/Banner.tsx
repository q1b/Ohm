...
export default function Banner() {
  return (
    <div className="py-2 overflow-hidden bg-gradient-to-r from-indigo-600 dark:from-orange-400 to-lightBlue-500 dark:to-rose-600">
      <div className="relative px-4 mx-auto max-w-8xl">
        <svg
          fill="none"
          viewBox="0 0 848 513"
        ...
        <div className="relative flex items-center justify-center">
          ...
          <span
            aria-hidden="true"
            className="hidden w-px h-6 mx-6 bg-white sm:block bg-opacity-20"
          ></span>
          <div className="ml-6 sm:ml-0">
            <a
              className="inline-flex px-3 py-2 text-xs font-semibold text-blue-500 uppercase bg-white rounded-md whitespace-nowrap hover:bg-opacity-90"
