...
export default function toggleButton() {
  ...
  return (
    <>
      <button
        onClick={ToggleTheme}
        className="p-1 mr-8 duration-500 ease-out transform rotate-90 rounded-full cursor-pointer sm:p-1 bg-blueGray-900 focus:outline-none focus:ring-2 dark:bg-orange-500"
      >
        <Transition
          show={dark}
        ...
        >
          <SunIcon className="w-8 h-auto text-white sm:w-12 " />
        </Transition>
        <Transition
          show={!dark}
          enter="transition-transform transition-opacity duration-1000 ease-in-out"
