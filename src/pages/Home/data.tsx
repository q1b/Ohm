...
const Impact_Data:Impact_Data[] = [
	{
		...
		year:2015,
		content:'Last year, the spiritual leader had travelled to Cuba, Havana and Colombia, talking to both the parties, building trust between them. Last year, Sri Sri travelled to Cuba to meet the representatives of FARC, including the leader of the FARC-EP delegation, Iván Márquez. His efforts resulted in a major breakthrough in June 2015 when the FARC rebels announced a unilateral ceasefire. The strife had taken the lives of 220,000 people and displaced more than 5 million. The government and the rebels had been talking peace since 2012, and had reached agreements on land reforms and drug trade. But what was needed was the healing touch of a spiritual leader that addressed the core values of the peace process. President Juan Manuel Santos remembered, "I had the great joy of speaking with him about his efforts to hopefully end an internal armed conflict that has lasted more than 50 years. Later on, with my consent, he met in Havana and Cuba with the negotiators of the FARC leaders to encourage them to follow the Gandhian principle of non-violence, and to cultivate the art of meditation and breathing." Márquez acknowledged that Sri Sri teachings about the Gandhian principle of non-violence inspired them With the help of Sri Sri, we have placed our spirit to achieve reconciliation and coexistence of a big and benevolent country, whose destiny can’t be that of the war. The teachings of the Art of Living are essential to achieve a stable and long-lasting peace."One year later, yesterday, the peace pact has been signed. Gurudev Sri Sri Ravi Shankar on Wednesday congratulated Juan Manuel Santos, the Colombian President and Marcos Carratala, the FARC negotiator for announcing a bilateral ceasefire. During last one year, Sri Sri had meetings and dialogues with both parties (See the timeline below). He taught his stress-elimination techniques to members of the Colombian government as well as the FARC that gave them the experience of peace and struck a chord within them. ',
		Icon:SunIcon,
		FromColor:'from-amber-400',
		ToColor:'to-orange-500',
		subHeadColor:'text-orange-500'
	},
	// {
	// 	index:2,
	// 	head:'Peace Mission',
	...
	// },
	{
		...
		Icon:GlobeIcon,
		FromColor:'from-lightBlue-500',
		ToColor:'to-blueGray-400',
		subHeadColor:'text-cyan-400'
	},
	// {
	// 	index:9,
	// 	head:'',
