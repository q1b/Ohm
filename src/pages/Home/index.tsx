...
export default function Home() {
	...
	const [content,setContent]= useState('You are Me as You breath I also breath, I eat you Eat , I care You care.')
				...
				<article className="absolute flex items-center justify-center h-[calc(100%-96px)] w-[calc(100%-10px)] top-[96px]">
					<div className="h-[97%] flex items-center justify-center md:w-[calc(90%)]  mt-2 md:mt-1 ">
						<Transition as={React.Fragment}
							...
							leave="transition-scale transform duration-500 ease-in-out"
							leaveFrom="opacity-100 scale-100"
							leaveTo="opacity-0 scale-50"
						>
							<img className={`h-full w-auto sm:w-full rounded-lg object-cover md:object-none"`} src={Img} alt="" />
						</Transition>
						<Transition as={React.Fragment} 
							show={visi}
