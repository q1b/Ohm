...
function SriSriProfileImage() {
  return (
    <>
      <a
        href="/"
        className="flex-shrink-0 mr-2 bg-gradient-to-b  from-[#FFFFFF] dark:from-lime-200 dark:via-green-500 dark:to-green-400 to-[#ff2987] rounded-full h-20 w-20 relative"
      >
        <img
