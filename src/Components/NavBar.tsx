                ...
                <Fragment>
                  <Menu.Button
                    ...
                    className={classNames(
                      PadAssign(NavItemData.NavItemPos),
                  ...
                  >
                    ...
                    <article className="flex w-[95%]">
                      <div
                        className={classNames(
                          NavItemData.SubItem ? (open ? "!opacity-0" : "") : "",
              ...
              <Menu.Item key={SubItemListItem.SubItemListId}>
                {({ active }) => {
                  return (
                    ...
                    >
                      {active ? (
                        <SubItemListItem.SolidIcon className="w-5 h-5 mr-3 text-indigo-900 dark:text-orange-900 animate-spin" />
                      ) : (
